...
public class DecoderAppMenu
{
    protected static final String SwipeSettingsInterface = null;
    private GestureListener mGestureListener;
    private GestureDetector mGestureDetector;
    private DecoderAppMenuAnimator mMenuAnimator;
    private Activity mActivity;
    private DecoderAppMenuInterface mMenuInterface;
    private GLSurfaceView mMovableView;
    private DecoderAppMenuView mParentMenuView;
    private LinearLayout mMovableListView;
    private ArrayList<DecoderAppMenuGroup> mSettingsItems = new ArrayList<DecoderAppMenuGroup>();
    ...
    public DecoderAppMenu(DecoderAppMenuInterface menuInterface,
                         ...
                         RelativeLayout parentView, ArrayList<View> additionalViewsToHide)
    {
        ...
        mParentMenuView = (DecoderAppMenuView) inflater.inflate(
                R.layout.decoder_app_menu_layer, null, false);
        ...
        if (!mIsBelowICS)
            mMenuAnimator = new DecoderAppMenuAnimator(this);
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener()
        {
            ...
            public void onGlobalLayout()
            {
                ...
                for (DecoderAppMenuGroup group : mSettingsItems)
                {
    ...
    public DecoderAppMenuGroup addGroup(String string, boolean hasTitle)
    {
        DecoderAppMenuGroup newGroup = new DecoderAppMenuGroup(mMenuInterface,
