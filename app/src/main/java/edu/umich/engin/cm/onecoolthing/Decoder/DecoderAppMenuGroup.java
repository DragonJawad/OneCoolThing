 ...
 */
public class DecoderAppMenuGroup
{

    Activity mActivity;
    DecoderAppMenuInterface mMenuInterface;
    ...
    public DecoderAppMenuGroup(DecoderAppMenuInterface menuInterface,
                              Activity context, DecoderAppMenu parent, boolean hasTitle, String title,
                              int width)
    {
        mActivity = context;
        ...
        titleView.setTextSize(mActivity.getResources().getDimension(
                R.dimen.decoder_menu_entries_title));
    ...
    public View addRadioItem(String text, int command, boolean isSelected)
    {
        ...
        RadioButton newRadioButton = (RadioButton) inflater.inflate(
                R.layout.decoder_app_menu_group_radio_button, null, false);
