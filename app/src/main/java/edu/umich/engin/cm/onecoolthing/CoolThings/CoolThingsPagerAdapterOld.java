...
import edu.umich.engin.cm.onecoolthing.Fragments.FragmentCoolThingOld;
 ...
 */
public class CoolThingsPagerAdapterOld extends FragmentPagerAdapter {
    // List of fragments to display
    ArrayList<FragmentCoolThingOld> listOfFragCoolThings;
    ...
    public CoolThingsPagerAdapterOld(FragmentManager fm) {
        super(fm);
    }
    ...
    public void initAdapter(Context context, ArrayList<CoolThing> coolThings) {
        ...
        listOfFragCoolThings = new ArrayList<FragmentCoolThingOld>();

        // Init fragments and with titles, for now
        for(int i = 0; i < pageLimit; ++i) {
            // Initialize fragment
            FragmentCoolThingOld thisFrag = new FragmentCoolThingOld();
    ...
    public Fragment getItem(int i) {
        // Get the fragment
        FragmentCoolThingOld frag = listOfFragCoolThings.get(i);
