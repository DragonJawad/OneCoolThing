...
package edu.umich.engin.cm.onecoolthing.DecoderV5.DecoderUtils.SampleAppMenu;
...
public class SampleAppMenuGroup
{
        ...
        int width)
    {
        ...
        mLayout = (LinearLayout) inflater.inflate(
            R.layout.decoder_sample_app_menu_group, null, false);
        ...
        dividerResource = R.layout.decoder_sample_app_menu_group_divider;
    ...
    public View addRadioItem(String text, int command, boolean isSelected)
    {
        ...
        RadioButton newRadioButton = (RadioButton) inflater.inflate(
            R.layout.decoder_sample_app_menu_group_radio_button, null, false);
