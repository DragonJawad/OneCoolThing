 ...
 */
public class DecoderAppMenuAnimator extends ValueAnimator implements
        ValueAnimator.AnimatorUpdateListener, ValueAnimator.AnimatorListener
{

    private static long MENU_ANIMATION_DURATION = 300;
    private DecoderAppMenu mSampleAppMenu;
    private float mMaxX;
    private float mEndX;


    public DecoderAppMenuAnimator(DecoderAppMenu menu)
    {
        mSampleAppMenu = menu;
